...
public static class HandUtil
{
    ...
    public static int valueOnePair(List<Card> h)
    {
        ...
        if (h.Count == 2)
            ...
            val = 14 * 14 * 14 * (int)h[0].rank + (int)h[2].rank + 14 * (int)h[3].rank + 14 * 14 * (int)h[4].rank;
        else if (h[1].rank == h[2].rank)
            val = 14 * 14 * 14 * (int)h[1].rank + (int)h[0].rank + 14 * (int)h[3].rank + 14 * 14 * (int)h[4].rank;
        else if (h[2].rank == h[3].rank)
            val = 14 * 14 * 14 * (int)h[2].rank + (int)h[0].rank + 14 * (int)h[1].rank + 14 * 14 * (int)h[4].rank;
        else
            val = 14 * 14 * 14 * (int)h[3].rank + (int)h[0].rank + 14 * (int)h[1].rank + 14 * 14 * (int)h[2].rank;
